...
INSERT INTO product (product_name, price_per_user, short_description, main_image)
VALUES ('Time Management System', 999.99, 'A comprehensive time management solution for enterprises', 'time_management.jpg'),
       ('Tax and Accounting Software', 899.99, 'A software solution for tax and accounting needs of enterprises', 'tax_accounting.jpg');

INSERT INTO license (license_id, valid, start_date, end_date, amount, company_id, product_name)
VALUES (1, true, '2021-01-01', '2021-12-31', 10000, 1, 'Time Management System'),
       (2, true, '2021-07-01', '2022-06-30', 5000, 2, 'Tax and Accounting Software');
...
INSERT INTO product_category (product_name, category_id)
VALUES ('Time Management System', 1),
       ('Tax and Accounting Software', 2);

INSERT INTO testemonial (testemonial_id, author, text, author_pic, product_name)
VALUES (1, 'Jane Doe', 'I am extremely impressed with the time management software provided by the company. It has greatly improved the efficiency of my team.', 'jane.jpg', 'Time Management System'),
       (2, 'John Smith', 'The tax software is a lifesaver. The software makes tax season a breeze and saves me so much time.', 'john.jpg', 'Tax and Accounting Software');
...
INSERT INTO description_component (component_id, priority, product_name, image_id, text_id)
VALUES (1, 1, 'Time Management System', 1, null),
       (2, 2, 'Time Management System', null, 1),
       (3, 1, 'Tax and Accounting Software', 2, null),
       (4, 2, 'Tax and Accounting Software', null, 2);

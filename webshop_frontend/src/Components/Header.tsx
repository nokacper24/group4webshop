            ...
            <header>
                <div className="header-container">
                    ...
                    <Link className="logo-link" to="/">
                        <svg className="logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 878 299">
                    ...
                    <nav>
                        ...
                        <div className="toggle-container">
                            <button id="nav-toggle" aria-label="Menu" aria-controls="primary-navigation" className=''>
                                <span className="hamburger" aria-hidden="true"></span>
                            </button>
                        </div>

                            <ul className="nav-list" id="primary-navigation" data-state="closed">
                                <li>
                                    {/* Searchbox */}
...
var navToggle: Element | null;
var navList: Element | null;

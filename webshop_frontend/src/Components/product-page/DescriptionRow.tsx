...
export default function DescriptionRow (row: ProductPageRow) {
    ...
    if(row.props.item1?.isTextNotImage && !row.props.item2?.isTextNotImage) { //if item1 is text but not item2
        if(row.props.textToLeft) {
            ...
            console.log("Item 1: " + row.props.item1.content + " Item 2: " + row.props.item2 + " functionID: 1");
        } else {
            rowElement = [ImageItem(row.props.item2),TextItem(row.props.item1)]
            console.log("Item 1: " + row.props.item1.content + " Item 2: " + row.props.item2 + " functionID: 2");
        }
        ...
        if(row.props.textToLeft) {
            ...
            console.log("Item 1: "  + " Item 2: " + row.props.item2 + " functionID: 3");
        } else {
            rowElement = [ImageItem(row.props.item1),TextItem(row.props.item2)]
            console.log("Item 1: " + " Item 2: " + row.props.item2 + " functionID: 4");
        }
        ...
        if (row.props.item1?.isTextNotImage && row.props.item2?.isTextNotImage) {
            ...
            console.log("Item 1: " + row.props.item1.content + " Item 2: " + row.props.item2 + " functionID: 5");
        } else {
            rowElement = [ImageItem(row.props.item1),ImageItem(row.props.item2)]
            console.log("Item 1: " + " Item 2: " + row.props.item2 + " functionID: 6");
        }
    }
    return (
        <div>
